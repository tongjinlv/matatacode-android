...
Code.init = function() {
  ...
  window.setTimeout(Code.importPrettify, 1);
    try {
        ...
        alert(MSG['init fail'].replace('%1', e));
    }
};
...
Code.runJS = function() {
  ...
  try {
    ...
    alert(MSG['codeend fail'].replace('%1', e));
  }
};
...
Code.checkcode = function() {
    try {
        ...
        alert(MSG['checkcode fail'].replace('%1', e));
    }
};
...
Code.deletecode = function() {
    try {
        ...
        alert(MSG['deletecode fail'].replace('%1', e));
    }
};
...
Code.helpbtn = function() {
    try {
        ...
        alert(MSG['helpbtn fail'].replace('%1', e));
    }
};
//GTY创建于2018年12月27日18:04:15 发送请求：通过蓝牙连接小车
...
//    let xml = Blockly.Xml.workspaceToDom(Blockly.getMainWorkspace());
    ...
    try {
        ...
        alert(MSG['getwscodes fail'].replace('%1', e));
    }
};
